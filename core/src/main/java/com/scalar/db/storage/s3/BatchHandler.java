...
public class BatchHandler extends StatementHandler {
  public BatchHandler(S3ClientWrapper wrapper, TableMetadataManager metadataManager) {
  ...
  public void handle(List<? extends Mutation> mutations) throws ExecutionException {
    for (Mutation mutation : mutations) {
      if (mutation instanceof Put) {
        ...
        throw new ExecutionException("Unsupported mutation type: " + mutation.getClass().getName());
      }
    }
  }
}
